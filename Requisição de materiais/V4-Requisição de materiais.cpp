			...
			case 9://leu um tab
				switch(etapa){
					...
					case ETAPA_OBSINT:
						...
						SimulaTecla(13,DELAY_ENTRE_CARACTERES);//enter
						SimulaTecla(9,DELAY_ENTRE_CARACTERES);//tab - preenche data da entrega
						SimulaTecla(9,DELAY_ENTRE_CARACTERES);//tab - preenche quantidade da entrega
						SimulaTecla(27,DELAY_ENTRE_CARACTERES);//esc - sai da edição da data e entrega
						printf(" [OK]");
						Sleep(delay_meio);
